...
export const initialAssessments: AssessmentResult[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      },
      {
        ...
        indicator: 'high',
        detail: 'Direct access provided to 24/7 Helpline (14566) and physiological sigh reset.'
      }
    ],
    highRiskFlag: true,
    smsStatus: 'SIMULATED',
  ...
  },
  {
    ...
    stressScore: 92,
    stressCategory: 'RISK',
    transcript: "I can't catch my breath, my chest is pounding intensely and I feel dizzy. I need emergency assistance immediately.",
    audioDuration: 7.5,
    acousticMetrics: {
      speakingWpm: 215,
      pauseLengthSeconds: 3.1,
      pitchFluctuationHz: 84.5,
      vocalTensionScore: 95,
      tempoRhythm: 'Severe vocal tremor, gasping phrase breaks, extreme subglottic tension'
    },
    sentimentMetrics: {
      sentimentScore: -0.92,
      anxietyLexiconScore: 96,
      fatigueKeywords: ['breath', 'pounding', 'dizzy', 'emergency'],
      primaryEmotion: 'Acute Panic & Critical Crisis'
    },
    breakdown: [
      {
        id: 'bk-1',
        title: 'Vocal Tremor & Laryngeal Spasm',
        metric: '84.5 Hz Pitch Instability',
        observation: 'Severe acoustic jitter and pitch destabilization indicating acute fight-or-flight sympathetic arousal.',
        indicator: 'risk',
        detail: 'Immediate somatic de-escalation required.'
      },
      {
        id: 'bk-2',
        title: 'Emergency SOS Protocol',
        metric: 'SMS & Helpline Active',
        observation: 'Automated emergency SMS dispatched to designated contact (14566).',
        indicator: 'risk',
        detail: 'Direct connection to 24/7 Helpline active.'
      }
    ],
    highRiskFlag: true,
    smsStatus: 'SENT',
    smsSid: 'SM_AUTO_RISK_991823',
    smsRecipient: '14566',
    smsDispatchedAt: new Date(Date.now() - 3600000 * 1).toISOString(),
    consularAlertTriggered: true,
...
class AssessmentStore {
  ...
  private users: UserProfile[] = [
    initialUser,
    {
      ...
      status: 'HIGH_RISK',
      notes: 'Acute stress alert triggered. Twilio SMS dispatched to 14566.'
    },
    {
      id: 'usr_33109',
      name: 'David Miller',
