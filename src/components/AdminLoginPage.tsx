      ...
      <div className="bg-white border border-stone-200/80 rounded-3xl p-8 shadow-xs space-y-6">
        ...
        <div className="space-y-2 text-center flex flex-col items-center">
          ...
          <h2 className="text-xl font-bold text-stone-900 tracking-tight">
            {t('admin.title', 'Wellbeing Admin Console')}
          </h2>
          <p className="text-xs text-stone-500">
            {t('admin.subtitle', 'Authorized portal for monitoring acoustic stress metrics, audit logs, and emergency SMS alerts.')}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          <div>
            <label className="block text-[11px] font-bold text-stone-700 uppercase tracking-wider mb-1">
              {t('login.name', 'Officer / Clinician Name')}
            </label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-[11px] font-bold text-stone-700 uppercase tracking-wider mb-1">
              {t('login.email', 'Administrator Email')}
            </label>
