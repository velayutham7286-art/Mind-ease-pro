  ...
  return (
    <div className="space-y-16 pb-20">
      ...
      <section className="text-center max-w-3xl mx-auto space-y-6 pt-6">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-teal-50 border border-teal-200/80 text-teal-800 text-xs font-semibold">
              <span>{t('home.badge', 'MindEase • Stress Relief & Vocal Biomarker Platform')}</span>
            </div>
            {/* Quick Language Indicator & Switcher */}
        ...
        >
          {t('home.title', 'A Calm Voice to Identify & Relieve Mental Stress.')}
        </motion.h1>
        ...
        >
          {t('home.subtitle', 'Mind Ease evaluates your speech through a gentle voice check-in. Identify cognitive stress and somatic body tension in seconds, receive transparent diagnostic insights, and access immediate grounding protocols.')}
        </motion.p>
            ...
            <div className="space-y-2">
              ...
              <div>
                <h3 className="font-bold text-stone-900 text-base group-hover:text-sky-800 transition-colors">
                  {t('home.startCardTitle', 'Start Stress Assessment')}
                </h3>
                <p className="text-xs text-stone-500 mt-0.5">
                  {t('home.startCardDesc', 'Record a short voice sample to identify cognitive and somatic stress.')}
                </p>
              </div>
            </div>

            <div className="mt-4 pt-3 border-t border-stone-100 flex items-center justify-between text-xs font-semibold text-sky-700">
              <span>{t('home.startCardBtn', 'Enter User Dashboard')}</span>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                <h3 className="font-bold text-stone-900 text-base group-hover:text-stone-900 transition-colors">
                  {t('home.adminCardTitle', 'Wellbeing Admin & Telemetry')}
                </h3>
                <p className="text-xs text-stone-500 mt-0.5">
                  {t('home.adminCardDesc', 'Monitor aggregated vocal stress levels, review audit logs, and test emergency helpline notifications.')}
                </p>
              </div>
            </div>

            <div className="mt-4 pt-3 border-t border-stone-100 flex items-center justify-between text-xs font-semibold text-stone-700">
              <span>{t('home.adminCardBtn', 'Admin Console')}</span>
            </div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="space-y-6">
        <div className="text-center space-y-1">
          <h2 className="text-xs font-bold uppercase tracking-wider text-stone-400">
            {t('home.pipelineBadge', 'Guided Stress Identification Pipeline')}
          </h2>
          <p className="text-xl font-bold text-stone-900">
            {t('home.pipelineTitle', 'How Voice Analysis Identifies Your Stress')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-white border border-stone-200/80 rounded-2xl p-6 shadow-xs space-y-3">
            ...
            <h3 className="font-bold text-stone-900 text-base">
              {t('home.step1Title', 'Natural Voice Check-in')}
            </h3>
            <p className="text-xs text-stone-600 leading-relaxed">
              {t('home.step1Desc', 'Speak naturally for 5–15 seconds: Share how your day or energy feels to capture authentic pitch, tempo, and vocal tension.')}
            </p>
            <div className="pt-2 text-[11px] text-sky-700 font-medium flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" />
              {t('home.step1Badge', 'Effortless single-recording capture')}
            </div>
          </div>
          ...
          <div className="bg-white border border-stone-200/80 rounded-2xl p-6 shadow-xs space-y-3">
            ...
            <h3 className="font-bold text-stone-900 text-base">
              {t('home.step2Title', 'Acoustic Analysis')}
            </h3>
            <p className="text-xs text-stone-600 leading-relaxed">
              {t('home.step2Desc', 'Analyzes speaking tempo (WPM), hesitation pause ratio, pitch jitter, and vocal fold strain alongside natural language sentiment markers.')}
            </p>
            <div className="pt-2 text-[11px] text-[#664D03] font-medium flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" />
              {t('home.step2Badge', 'Objective vocal frequency diagnostics')}
            </div>
          </div>
          ...
          <div className="bg-white border border-stone-200/80 rounded-2xl p-6 shadow-xs space-y-3">
            ...
            <h3 className="font-bold text-stone-900 text-base">
              {t('home.step3Title', 'Stress Identification & Relief')}
            </h3>
            <p className="text-xs text-stone-600 leading-relaxed">
              {t('home.step3Desc', 'Receive an instant 0–100 Stress Score with transparent diagnostic cards, 24/7 Helpline support (14566), and personalized breathing exercises.')}
            </p>
            <div className="pt-2 text-[11px] text-sky-700 font-medium flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" />
              {t('home.step3Badge', 'Immediate relief & emergency helpline')}
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="space-y-2 flex-1">
            <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-sky-800 bg-sky-100 px-2.5 py-0.5 rounded-full">
              ...
              {t('home.supportBadge', '24/7 Dedicated Support')}
            </div>
            <h3 className="text-xl font-bold text-stone-900">
              {t('home.supportTitle', 'Immediate Crisis & Stress Support Hotline')}
            </h3>
            <p className="text-xs text-stone-600 leading-relaxed max-w-2xl">
              {t('home.supportDesc', 'If your stress assessment indicates high acute stress or you are feeling overwhelmed, direct telephone support is available at 14566 (India) alongside guided 4-7-8 and Box breathing exercises.')}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            ...
            >
              {t('home.startBtn', 'Start Your Check-in')}
            </button>
            <a
              href="tel:14566"
