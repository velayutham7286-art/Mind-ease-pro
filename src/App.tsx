    ...
    const unsubscribe = onAuthStateChanged(auth, async (fbUser) => {
      if (fbUser && !currentUser) {
        ...
        const liveUser: UserProfile = {
          ...
          age: profileData?.age,
          emergencyPhone: profileData?.emergencyPhone || '14566',
    ...
    <div className="min-h-screen bg-[#FAF9F6] text-stone-800 flex flex-col selection:bg-sky-100 selection:text-sky-900">
      ...
      <header className="sticky top-0 z-40 bg-[#FAF9F6]/95 backdrop-blur-md border-b border-stone-200/70 px-3 sm:px-6 md:px-8 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
          ...
          <nav className="hidden md:flex items-center gap-1 bg-stone-100/90 p-1 rounded-xl border border-stone-200/80">
            ...
            {currentUser && (
              ...
              >
                ...
                <span>{t('nav.checkIn', 'Voice Check-in')}</span>
              </button>
            )}
            ...
            >
              ...
              <span>{t('nav.chat', 'Gemini AI Chat')}</span>
          ...
          {/* Right Side: Authentication, Language Selector & Profile */}
      ...
      <footer className="mt-auto border-t border-stone-200/70 py-6 px-4 text-center text-xs text-stone-500 space-y-2 mb-16 md:mb-0">
        ...
        <p className="text-[11px] text-stone-400">
          Real-Time Voice Analysis • Google Firebase Auth & Firestore • 24/7 Crisis Support: 14566
        </p>
      </footer>
      ...
      >
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.home', 'Home')}</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.checkIn', 'Check-in')}</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.chat', 'AI Chat')}</span>
        </button>
        ...
        {currentUser ? (
          currentUser.role === 'ADMIN' ? (
            ...
            >
              ...
              <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.adminConsole', 'Admin')}</span>
            </button>
          ) : (
            <button
              onClick={() => {
            ...
            >
              ...
              <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.accountSession', 'Account')}</span>
            </button>
          )
        ) : (
          <button
          ...
          >
            ...
            <span className="text-[10px] mt-0.5 tracking-tight">{t('nav.signIn', 'Sign In')}</span>
          </button>
        )}
      </nav>
    </div>
